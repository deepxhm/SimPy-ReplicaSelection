...
latencydata <- c(prefix,quantile(latency$Latency, c(0.5, 0.95, 0.99, 0.999)), range50, range95, range99)

write.table(latencydata,file=paste(prefix, "_99thlatency.txt", sep=""),quote = FALSE, row.names = FALSE, col.names = FALSE)
